...
class RestaurantOrderManagement:
    def __init__(self,root):
        ...
        for i,(item,price) in enumerate(self.menu_items.items(),start=1):
            ...
            self.menu_quntities[item]=quantity_entry
    ...
    def setup_background(self,root):
        ...
        original_image=tk.PhotoImage(file="Restaurant_Management_bg.png")
    ...
    def place_order(self):
        ...
        for item,entry in self.menu_quntities.items():
            quantity=entry.get()
            if quantity.isdigit():
        ...
        if total_cost>0:
            ...
            messagebox.showwarning("Please select at least one item to place an order.")
